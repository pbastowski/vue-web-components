...
var css_base = __webpack_require__("a571");
...
// CONCATENATED MODULE: /usr/local/lib/node_modules/@vue/cli-service-global/node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"2261f158-vue-loader-template"}!/usr/local/lib/node_modules/@vue/cli-service-global/node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!/usr/local/lib/node_modules/@vue/cli-service-global/node_modules/cache-loader/dist/cjs.js??ref--0-0!/usr/local/lib/node_modules/@vue/cli-service-global/node_modules/vue-loader/lib??vue-loader-options!./App.vue?vue&type=template&id=41524b17&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('h1',[_vm._v("Vue Web Component")]),_c('hr'),_c('form',{on:{"submit":function($event){$event.preventDefault();return _vm.addText($event)}}},[_c('label',[_vm._v("\n            Name\n            "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.text),expression:"text"}],domProps:{"value":(_vm.text)},on:{"input":function($event){if($event.target.composing){ return; }_vm.text=$event.target.value}}})])]),_vm._l((_vm.texts),function(item){return _c('p',[_vm._v("\n        "+_vm._s(item)+"\n        "),_c('button',{on:{"click":function($event){return _vm.removeItem(item)}}},[_vm._v("delete")])])})],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./App.vue?vue&type=template&id=41524b17&
...
window.customElements.define('vue-wc-01', dist_vue_wc_wrapper(external_Vue_default.a, App)); // import Vue from 'vue'
...
window.customElements.define('vue-wc-01', vue_wc_wrapper(external_Vue_default.a, /* Cannot get final name for export "default" in "./main.js?shadow" (known exports: , known reexports: ) */ undefined))

/***/ })

/******/ });
//# sourceMappingURL=vue-wc-01.js.map